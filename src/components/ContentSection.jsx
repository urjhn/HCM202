      ...
      <div className="flex gap-4 mt-4 mb-6 items-start">
        ...
        <div className="flex-1 pt-1" style={{ maxWidth: '600px' }}>
          <p className="text-[0.95rem] leading-[1.4]" 
            ...
            <span className="font-bold">Hồ Chí Minh</span> (tên khai sinh là Nguyễn Sinh Cung, sau đó là Nguyễn Tất Thành và Nguyễn Ái Quốc trong những năm hoạt động cách mạng) sinh ngày 19 tháng 5 năm 1890 tại làng Kim Liên, huyện Nam Đàn, tỉnh Nghệ An, và qua đời ngày 2 tháng 9 năm 1969 tại Hà Nội.
          </p>
        </div>
      </div>
          ...
          <div className="text-[0.875rem] leading-[1.6] space-y-3" 
            ...
            <p style={{ textAlign: 'justify' }}>
              <span className="float-left text-[4.5rem] font-bold leading-[0.85] mr-[0.15rem] mt-[0.1rem]" 
                    style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>C</span>
              hủ tịch Hồ Chí Minh là một người yêu nước chân chính, một nhà cách mạng sáng suốt và một lãnh tụ thiên tài. Cuộc đời và sự nghiệp cách mạng của Người gắn liền với lịch sử hào hùng của dân tộc Việt Nam. Người đã cống hiến trọn đời cho sự nghiệp giải phóng dân tộc của nhân dân Việt Nam, góp phần vào cuộc đấu tranh chung của các dân tộc vì hòa bình, độc lập, dân chủ và tiến bộ xã hội.
            </p>
            
            <p style={{ textAlign: 'justify' }}>
              Năm 1987, UNESCO vinh danh Hồ Chí Minh là "Anh hùng giải phóng dân tộc, Danh nhân văn hóa kiệt xuất của Việt Nam". Tư tưởng của Người kết hợp chủ nghĩa yêu nước với chủ nghĩa quốc tế, hòa quyện giá trị truyền thống Việt Nam với tư tưởng cách mạng hiện đại. Qua những bài viết và hành động của mình, Người đã truyền cảm hứng cho nhiều thế hệ người Việt Nam đấu tranh vì tự do và nhân phẩm của đất nước.
            </p>
          </div>
        </div>
      </div>
